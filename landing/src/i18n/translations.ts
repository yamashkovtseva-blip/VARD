...
export const translations = {
  en: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          ...
          price: '$49',
          period: 'per user / month · from 5 seats',
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'Community is free under BSL for internal use, up to 5 users, with community support. Pro adds project-level RBAC, audit log, notebook versioning, priority email support, and removes the seat limit (sold from 5 seats up). Both run entirely on your infrastructure.',
        },
        {
    ...
    calculator: {
      ...
      subtitle: 'Tell us about your team — we’ll recommend the right tier.',
      usersLabel: 'How many users on your team?',
      proLabel: 'Pro features you need',
      enterpriseLabel: 'Enterprise features',
      features: {
        rbac: 'Project RBAC',
        audit: 'Audit log',
        versioning: 'Notebook versioning',
        priority: 'Priority email support',
        sso: 'SSO / SAML / OIDC',
        fullAudit: 'Full audit log export',
        customConnectors: 'Custom connectors',
        csm: 'Dedicated CSM',
        sla: '99.9% SLA',
      },
      result: {
        recommendedLabel: 'Recommended plan',
        perMonth: '/ month',
        minSeats: '5-seat minimum applies — billed for 5 seats',
        contact: 'Talk to sales for a quote',
        communityNote: 'Free forever for internal use, up to 5 users.',
        proNote: 'Run locally, $49/seat/month, billed monthly via Stripe.',
        enterpriseNote: 'Custom contract, SSO, SLA, dedicated CSM.',
      },
      tiers: {
        community: 'Community',
        pro: 'Self-hosted Pro',
    ...
    contact: {
      ...
      githubLabel: 'GitHub',
      githubHref: 'github.com/smarianna24/VARD',
  ...
  ru: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          name: 'Self-hosted Pro',
          price: '$49',
          period: 'за пользователя / мес · от 5 мест',
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'Community бесплатен по BSL для внутреннего использования, до 5 пользователей, поддержка через сообщество. Pro добавляет проектный RBAC, audit log, версионирование ноутбуков, приоритетную email-поддержку и снимает лимит на пользователей (продаётся от 5 мест). Оба варианта работают полностью на вашей инфраструктуре.',
        },
        {
    ...
    calculator: {
      ...
      subtitle: 'Расскажите про команду — подскажем подходящий уровень.',
      usersLabel: 'Сколько пользователей в команде?',
      proLabel: 'Нужные Pro-функции',
      enterpriseLabel: 'Enterprise-функции',
      features: {
        rbac: 'Проектный RBAC',
        audit: 'Audit log',
        versioning: 'Версионирование ноутбуков',
        priority: 'Приоритетная email-поддержка',
        sso: 'SSO / SAML / OIDC',
        fullAudit: 'Полный экспорт audit log',
        customConnectors: 'Кастомные коннекторы',
        csm: 'Выделенный CSM',
        sla: '99.9% SLA',
      },
      result: {
        recommendedLabel: 'Рекомендованный тариф',
        perMonth: '/ месяц',
        minSeats: 'Минимум 5 мест — счёт выставляется за 5',
        contact: 'Свяжитесь с продажами для расчёта',
        communityNote: 'Бесплатно навсегда для внутреннего использования, до 5 человек.',
        proNote: 'Self-hosted, $49/место/мес, биллинг через Stripe.',
        enterpriseNote: 'Кастомный контракт, SSO, SLA, выделенный CSM.',
      },
      tiers: {
        community: 'Community',
        pro: 'Self-hosted Pro',
      ...
      ctaCommunity: 'Запустить бесплатно',
      ctaPro: 'Триал 14 дней',
      ctaEnterprise: 'Связаться с продажами',
      rubLabel: '≈ в рублях',
    },
    finalCta: {
